...
class Table implements TableInteraface, Iterator, Countable
{
    ...
    public function setDb(ClientInterface $db)
    {
      $this->_db = $db;
      return $this;
    }
    ...
    * @return array|$this
    */
    public function addFieldXXXXXXXXXXXXXXX($asField)
    {
      $this->_fieldBack = $this->_field;
